...
- Configured multiple Windows event channels for log forwarding:
 ...
 - Successfully verified deployment of the DCR, confirming that Azure Monitor Agent is active and ready to forward event data to the workspace.
 - This integration establishes the telemetry pipeline between the VM and Sentinel, allowing advanced threat analytics, correlation, and visualization across all Mini-SOC resources.
